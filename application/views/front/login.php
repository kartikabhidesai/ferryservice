        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <section id="third-tab-group" class="recommendedgroup">
                    <div id="livingroom" style="display: block;">
                        <div class="text-content">
                            <iframe width="100%" height="400px" src="https://www.youtube.com/embed/rMxTreSFMgE">
                            </iframe>
                        </div>
                    </div>
                    <div id="suitroom" style="display: none;">
                        <div class="row">
                            <div class="col-md-12">
                                <div id="owl-suiteroom" class="owl-carousel owl-theme" style="opacity: 1; display: block;">
                                    <div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 3702px; left: 0px; display: block; transition: all 800ms ease; transform: translate3d(-1234px, 0px, 0px);"><div class="owl-item" style="width: 617px;"><div class="item">
                                                ...
                                                </div></div><div class="owl-item" style="width: 617px;"><div class="item">
                                                    <div class="suiteroom-item">
                    ...
                    <div id="swimingpool" style="display: none;">
